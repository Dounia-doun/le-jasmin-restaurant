    ...
    <footer style={{
      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
        <div style={{
          ...
          {/* Brand */}
          <div>
            <img src="/Public/images/logo.png" alt="Le Jasmin" style={{ height: '80px', width: 'auto', marginBottom: '1.25rem', filter: 'brightness(1.1)' }} />
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
            <img src="/Public/images/logo.png" alt="Le Jasmin" style={{ height: '28px', opacity: 0.5 }} />
